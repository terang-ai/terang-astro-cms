...
slug: 'terang-ai-nama-summit-2025'
canonicalURL: 'https://blog.terang.ai/terang-ai-nama-summit-2025'
ogType: 'article'
ogTitle: 'Terang AI Hadir Sebagai Pembicara di NAMA Summit 2025 untuk Dorong Akses Pendidikan Inklusif Berbasis AI'
ogDescription: 'Terang AI menjadi pembicara di NAMA Summit 2025 dengan tema Breaking Barriers: Expanding Access to Quality Education for All, membagikan 5 pelajaran utama dalam membangun solusi pendidikan berbasis AI'
twitterTitle: 'Terang AI Speaks at NAMA Summit 2025 on AI-Driven Inclusive Education'
twitterDescription: 'Indonesian AI education startup Terang AI shares insights on leveraging AI technology for inclusive and accessible education at NAMA Summit 2025 in Jakarta'
---
...
Dalam sesi Forum 18 bertajuk **"Bridging the Gap – Leveraging Technology for Inclusive and Accessible Education,"** Muhamad Fahriza Novriansyah, Co-Founder & CEO Terang Inovasi Indonesia (Terang AI), memaparkan bagaimana teknologi AI dapat menjembatani kesenjangan pembelajaran dan membantu siswa dari berbagai latar belakang mendapatkan pengalaman belajar yang personal dan adaptif. 
...
### Lima Pelajaran Utama dari Perjalanan Terang AI
...
1. **AI enables scalable inclusion** – AI memungkinkan personalisasi pembelajaran dalam skala luas dengan efisiensi tinggi.
2. **Localization matters** – Teknologi pendidikan harus memahami konteks sosial, budaya, dan perilaku pengguna lokal.
3. **Community partnerships amplify impact** – Kolaborasi dengan komunitas lokal memperkuat adopsi dan kepercayaan publik. Salah satunya kerjasama dengan organisasi Mata Garuda Papua, Beasiswa Timur, PPI Wageningen, dan BBAF untuk aktivasi program gratis di wilayah 3T dengan memberikan akses pembelajaran gratis untuk wilayah Papua dan NTT.
...
### Dampak untuk Pendidikan Global

Partisipasi dalam NAMA Summit 2025 menunjukkan bahwa:
- Indonesia memiliki kontribusi nyata dalam inovasi pendidikan global
- Teknologi AI dapat menjadi solusi untuk tantangan aksesibilitas pendidikan
- Kolaborasi internasional membuka peluang pengembangan yang lebih luas
- Startup EdTech Indonesia siap berkompetisi di tingkat global
